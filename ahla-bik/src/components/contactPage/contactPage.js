...
class ContactPage extends Component {
    ...
    render() { 
        return ( <div>
            ...
            <div className="hero-wrap js-fullheight" style={{backgroundImage: 'url("images/bg_1.jpg")', height: '625px'}}>
