          ...
          <div className="row mb-5">
            ...
            <div className="col-md">
              <div className="ftco-footer-widget mb-4">
                ...
                <ul className="list-unstyled">
                  <li><a href="#" className="py-2 d-block">Lunch</a></li>
                  <li><a href="#" className="py-2 d-block">Drink</a></li>
                  <li><a href="#" className="py-2 d-block">Brunch</a></li>
                  <li><a href="#" className="py-2 d-block">Guided tour</a></li>
                  <li><a href="#" className="py-2 d-block">Sport</a></li>
                </ul>
              </div>
            </div>
              ...
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="block-23 mb-3">
                  <ul>
                    ...
                    <li><a href="#"><span className="icon icon-phone" /><span className="text">+216 55 666 777</span></a></li>
                    <li><a href="#"><span className="icon icon-envelope" /><span className="text">contact@ahlabik.tn</span></a></li>
                  </ul>
                </div>
              </div>
            </div>
